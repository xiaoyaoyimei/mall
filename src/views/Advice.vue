			...
			<Form ref="tousuForm" class="form" :model="tousuForm" :rules="ruleInline">
				...
				<FormItem>
					<div>
						...
						<Upload ref="evaupload" :show-upload-list="false" :default-file-list="defaultList" :on-success="evauploadhandleSuccess" :format="['jpg','jpeg','png']" :max-size="2048" :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize" :before-upload="evahandleBeforeUpload" multiple type="drag" :action="uploadUrl" v-if="showFile" style="display: inline-block;width:80px;">
